 ...
 *
 * @author 沈东良shendl_s@hotmail.com
 * Nov29,2006 10:34:34AM
 * 用来加载类，ｃｌａｓｓｐａｔｈ下的资源文件，属性文件等。
 * getExtendResource(StringrelativePath)方法，可以使用../符号来加载 classpath外部的资源。
 */
...
public class ClassLoaderUtil {
     ...
     * *@paramrelativePath必须传递资源的相对路径。是相对于classpath的路径。如果需要查找 classpath外部的资源，需要使用../来查找
     * *@return 文件输入流
     * *@throwsIOException
    ...
    /**
     *  *
     *  *@paramrelativePath必须传递资源的相对路径。是相对于classpath的路径。如果需要查找classpath外部的资源，需要使 用../来查找
     * *@return
     * *@throwsMalformedURLException
     * *@throwsIOException
     *
    ...
    /**
     * *
     *  *@paramrelativePath 必须传递资源的相对路径。是相对于classpath的路径。如果需要查找classpath外部的资源，需要 使用../来查找
     * *@return资 源的绝对URL
     *  *@throwsMalformedURLException
     *
     */
    ...
    getExtendResource(String relativePath) throws MalformedURLException {
        ...
        ClassLoaderUtil.log.debug(""+Integer.valueOf(relativePath.lastIndexOf("../")));
